...
/*
 * Probe order for VMBus protocol 5.0 and newer.
 * Older protocols ignore this argument and keep using
...
int vmbus_negotiate_version(struct vmbus_channel_msginfo *msginfo, u32 version)
{
	...
	/*
	 * Protocol 5.0+ can use the redirect ID; older protocols ignore
	 * the supplied ID and should only be sent once.
	 */
	if (version >= VERSION_WIN10_V5) {
