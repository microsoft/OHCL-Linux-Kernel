...
linked virtual addresses; it does not permit virtual KASLR. The loader requires
this bit and rejects fixed-address targets. Flag bit 1 means the
...
distribution of timings across repeated boots. Load/unload testing does not
